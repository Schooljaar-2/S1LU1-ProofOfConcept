...
export function findCustomerByFirstLastOrEmail(searchterm, active, offset, overdueFirst, callback){
    ...
    manageCustomerDao.searchCustomers(searchterm, normalizedActive, offset, overdueFirst, (errorSearch, customers) => {
    if (errorSearch) {
            const error = {
                status: 500,
